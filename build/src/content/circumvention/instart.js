 ...
 */
import { getWindowHostname, magic as contentScriptMagic } from '../helpers';
 ...
 */
var shieldPropertiesFromInstart = bundle(function (magic) {
 ...
 */
var monkeyPatchNanoVisor = bundle(function (magic) {
    ...
    var nanoVisorProxy = new Proxy({}, {
        ...
        set: function (target, name, value) {
            switch (name) {
                case 'CanRun':
                    // @ts-ignore
                    target.CanRun = function () { return false; };
                    break;
                default:
                    // @ts-ignore
                    target[name] = value;
...
export default function instart(window) {
