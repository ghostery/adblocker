...
test.describe('Browser-based CSS matching tests', () => {
  ...
  test('Browser-based CSS matching tests: :matches-css matches element with exact CSS property value', async ({
    page,
  }) => {
  ...
  test('Browser-based CSS matching tests: :matches-css does not match element with different CSS property value', async ({
    page,
  }) => {
    await page.setContent(
