...
export default [
  ", %2F*start*%2F(function()%7Blet%20link%3Ddocument.createElement(%22link%22)%3Blink.rel%3D",
  ")%7D)()%3Bdocument.currentScript.textContent%3Ddocument.currentScript.textContent.replace(",
  "div[style=\"position: absolute; inset: 0px; overflow: hidden; z-index: 160; background: tra",
  "div[style=\"position: fixed; display: block; width: 100%; height: 100%; inset: 0px; backgro",
  "rmnt, script, %2F%22v4ac1eiZr0%22%7C%22%22%5C)%5C.split%5C(%22%2C%22%5C)%5C%5B4%5C%5D%7C%5",
  "trusted-set-cookie, SOCS, CAISNQgQEitib3FfaWRlbnRpdHlmcm9udGVuZHVpc2VydmVyXzIwMjQwNTE0LjA2",
  "^script:has-text('/\"v4ac1eiZr0\"|\"\"\\)\\.split\\(\",\"\\)\\[4\\]|\\.localStorage\\)\\.getItem\\(\"/')",
  "\"]:not([style^=\"width: 1px; height: 1px; position: absolute; left: -10000px; top: -\"])",
  "%2F%5C%2F%5C*start%5C*%5C%2F(.*)%5C%2F%5C*end%5C*%5C%2F%2Fg%2C%22%22)%3B%2F*end*%2F",
  ...
  "X3AwGgJmaSADGgYIgOu0sgY, 1year, , domain, google.",
